...
HD_PWD='C:/Users/perhat.amanlyyev/cs223-3/cs223-3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log combin.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source combin.tcl
