...
HD_PWD='C:/Users/perhat.amanlyyev/cs223-2/cs223-2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log myltiplyBy3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source myltiplyBy3.tcl -notrace
