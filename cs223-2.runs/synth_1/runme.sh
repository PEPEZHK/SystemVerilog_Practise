...
HD_PWD='C:/Users/perhat.amanlyyev/cs223-2/cs223-2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myltiplyBy3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myltiplyBy3.tcl
